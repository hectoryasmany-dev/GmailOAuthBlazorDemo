...
using GmailOAuthBlazorDemo.Blazor.Server.Services;
...
namespace GmailOAuthBlazorDemo.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<GmailOAuthBlazorDemoBlazorApplication>(Configuration);
            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "GmailOAuthBlazorDemo API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the GmailOAuthBlazorDemo.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
            if(env.IsDevelopment()) {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "GmailOAuthBlazorDemo WebApi v1");
                });
            }
            else {
