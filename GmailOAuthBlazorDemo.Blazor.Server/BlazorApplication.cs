...
namespace GmailOAuthBlazorDemo.Blazor.Server {
    public partial class GmailOAuthBlazorDemoBlazorApplication : BlazorApplication {
        public GmailOAuthBlazorDemoBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void GmailOAuthBlazorDemoBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
